...
// GET /api/kanban/boards — List all boards with columns
...
router.post('/boards', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_board_created', { board });
...
router.patch('/boards/:id', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_board_updated', { board });
    res.json(board);
  } catch (error) {
...
router.delete('/boards/:id', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_board_deleted', { boardId });
...
// POST /api/kanban/columns — Create column in board
router.post('/columns', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_column_created', { column });
...
router.patch('/columns/:id', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_column_updated', { column });
    res.json(column);
  } catch (error) {
...
router.delete('/columns/:id', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_column_deleted', { columnId: colId, boardId: col.boardId });
...
router.post('/columns/reorder', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_columns_reordered', { columnOrders });
    res.json({ ok: true });
  } catch (error) {
...
router.get('/tasks', async (req, res) => {
  try {
    ...
    if (label) where.labels = { contains: label };
...
router.post('/tasks', async (req, res, next) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_created', { taskId: task.id, task: formatTaskClient(task) });
...
router.patch('/tasks/:id', async (req, res, next) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_updated', { taskId, task: formatTaskClient(updatedTask) });
...
// POST /api/kanban/tasks/:id/move — Drag & drop task movement
router.post('/tasks/:id/move', async (req, res, next) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_moved', {
      taskId,
      columnId: newColumnId,
      order: data.order,
...
router.post('/tasks/:id/archive', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_archived', { taskId, isArchived: newArchived });
...
router.delete('/tasks/:id', async (req, res, next) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_deleted', { taskId });
...
router.post('/tasks/:id/checklist', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_checklist_updated', { taskId });
...
router.post('/tasks/:id/comments', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_comment_added', { taskId, comment });
...
router.delete('/tasks/:id/comments/:commentId', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_comment_deleted', { taskId, commentId });
...
router.post('/tasks/:id/attachments', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_attachment_added', { taskId, attachment });
...
router.delete('/tasks/:id/attachments/:attId', async (req, res) => {
  try {
    ...
    broadcastTaskEvent(req, 'kanban_task_attachment_deleted', { taskId, attId });
