...
- **Unique New Inquiries Chart Analytics:** Boshqaruv panelidagi "Murojaatlar (Yangi yozganlar)" grafik ko'rsatkichi mijozning bazadagi ro'yxatdan o'tgan sanasiga (`createdAt`) qarab hisoblanadigan bo'ldi. Bu orqali eski mijozlar faol yozishmalarining yangi murojaatlar statistikasi bilan qo'shilib chalkashib ketishi bartaraf etildi.
